...
vkbot1.py - тут содержаться "мозг" бота и все условия для выполнения команд.
based1.py - тут создержаться сами команды.
config1.py - тут содержаться переменные, которые каждому юзеру нужно будет задать
...
За это отвечает программа based1.py, т.е. при ее запуске будет производится проверка. Так что чтоб ее автоматизировать, рекомендую использовать
